...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        "open:fade-in-0 closed:fade-out-0 fixed inset-0 isolate z-50 closed:animate-out bg-black/30 duration-100 open:animate-in supports-backdrop-filter:backdrop-blur-sm",
        className
      )}
